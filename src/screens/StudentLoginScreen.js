...
export default function StudentLoginScreen() {
    ...
    const handleLogin = () => {
        const newErrors = {};
        if (!username.trim()) newErrors.username = 'Name / Username is required';
            ...
            >
                <ScrollView contentContainerStyle={styles.formContainer} showsVerticalScrollIndicator={false}>
                    <View style={styles.formHeader}>
                        ...
                        <Text style={styles.headerTitle}>Hi there, student</Text>
                        <Text style={styles.headerSubtitle}>Enter your details to join a class</Text>
                    </View>
